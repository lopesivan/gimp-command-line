...
# Rectangular QAM Constelation __k odd in 2^k = N__

from math import *
from gimpfu import *
from constellations import *

def gen_constellation_qam_r_ko(bg_colour, stars_colour, area_colour, axis_colour, power):
	...
	y_top_right = Y_BASE - cos(pi/4) * rad
	x_top_right = X_BASE + sin(pi/4) * rad
	s = (n+4)/4 # stars in the side of the square
	size = ((x_top_right - X_BASE) * 2) / (s-1)

	draw_desicion_area(img, layer, x_top_right, y_top_right, size)
	...
	draw_stars_square(img, layer, n, rad, X_BASE, Y_BASE)
...
register(
	"gen_constellation_qam_r_ko",
	"Generate a rectangular QAM modulation constelation",
	"Generate a rectangular QAM modulation constelation",
	"Juanjo Conti",
	"Juanjo Conti",
	"2006",
	"<Toolbox>/Xtns/Python-Fu/Constellations/rectangular-QAM-kodd",
	"",
	[
        ...
        (PF_SPINNER, "power", "El numero de estrellas en la constelacion es 2^:", 3, (3,7,2))
	],
	[],
	gen_constellation_qam_r_ko)
